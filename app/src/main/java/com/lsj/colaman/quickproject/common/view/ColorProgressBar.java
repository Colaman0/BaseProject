...
public class ColorProgressBar extends ProgressBar {
    ...
    public ColorProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int color = typedArray.getColor(R.styleable.ColorProgressBar_progress_color, ContextCompat.getColor(context, R.color.colorAccent));
        typedArray.recycle();
    ...
    protected void setHorizontalStyleColor(int firstColor) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            ...
            progressDrawable.setColorFilter(firstColor, android.graphics.PorterDuff.Mode.SRC_IN);
